...
return array(
    ...
    'info' => array(
        ...
        'icon'        => '',
        'icon_color'  => '',
        'image'       => 'webpos.png',    //默认指向当前模块view/admin/static/image/webpos.png
        'description' => 'Webpos系统，Web版收银系统，可实时无缝与线上平台打通',
        'author'   	  => 'Runtuer',
    ...
    'admin_menu' => array(
        ...
        是否权限控制 ：1，是，0：否
         **/
        'Webpos'    => array('','l', 'webpos/admin.index/index', 'webpos.png', '', 1, 1),
    )
);