...
// +----------------------------------------------------------------------
// | Clickandbuy  Version 1.0  2016/3/14
// +----------------------------------------------------------------------
namespace payments;

use app\common\libs\Payment;

class Clickandbuy extends Payment
{
    /**
     * @Mark:扩展配置信息
     * @Author: theseaer <theseaer@qq.com>
    ...
    public static function setup(){
        return array(
            ...
            'code'          => 'Clickandbuy',     // 扩展器名称名
            'name'          => lang('Clickandbuy_payment'), // 扩展器名称翻译名
            'description'   => lang('Clickandbuy_payment_desc'), // 扩展器名称翻译描述
            'version'       => '1.0',                                    //版本
            'author'        => 'Runtuer',                                //作者
            ...
            //特殊配置项目，可自行定义
            'special'       => array(
                'logo'      => 'clickandbuy.png',
                'appofficial'  => 'http://www.clickandbuy.com/',       //官方
                'country'   => ['en-us'],   //适用国家
            ),
        );
    }
