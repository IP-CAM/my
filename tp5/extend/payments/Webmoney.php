...
// +----------------------------------------------------------------------
// | Webmoney  Version 1.0  2016/3/14
// +----------------------------------------------------------------------
namespace payments;
...
class Webmoney extends Payment
{
    ...
    public static function setup(){
        return array(
            ...
            'code'          => 'Webmoney',     // 扩展器名称名
            'name'          => lang('Webmoney_payment'), // 扩展器名称翻译名
            'description'   => lang('Webmoney_payment_desc'), // 扩展器名称翻译描述
            'version'       => '1.0',                                    //版本
            'author'        => 'Runtuer',                                //作者
            ...
            'special'       => array(
                'logo'      => 'webmoney.png',
                'appofficial'  => 'https://www.wmtransfer.com/',       //官方
                'country'   => ['en-us'],   //适用国家
            ),
        );
    }
