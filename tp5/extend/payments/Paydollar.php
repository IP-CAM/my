...
// +----------------------------------------------------------------------
// | Paydollar  Version 1.0  2016/3/14
// +----------------------------------------------------------------------
namespace payments;
use app\common\libs\Payment;

class Paydollar extends Payment
{
    /**
     * @Mark:扩展配置信息
     * @Author: theseaer <theseaer@qq.com>
    ...
    public static function setup(){
        return array(
            ...
            'code'          => 'Paydollar',     // 扩展器名称名
            'name'          => lang('Paydollar_payment'), // 扩展器名称翻译名
            'description'   => lang('Paydollar_payment_desc'), // 扩展器名称翻译描述
            'version'       => '1.0',                                   //版本
            'author'        => 'Runtuer',                               //作者
            ...
            'special'       => array(
                'logo'      => 'paydollar.png',
                'appofficial'  => 'http://www.paydollar.com.cn/',       //官方
                //'country'   => ['zh-cn'],   //适用国家
            ),
        );
    }
