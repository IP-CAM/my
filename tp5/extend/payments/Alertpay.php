...
// +----------------------------------------------------------------------
// | Alertpay  Version 1.0  2016/3/14
// +----------------------------------------------------------------------
namespace payments;

use app\common\libs\Payment;

class Alertpay extends Payment
{
    /**
     * @Mark: 退款
     * @param $sendData
    ...
    static public function setup(){
        return array(
            ...
            'code'          => 'Alertpay',     // 扩展器名称名
            'name'          => lang('Alertpay_payment'), // 扩展器名称翻译名
            'description'   => lang('Alertpay_payment_desc'), // 扩展器名称翻译描述
            'version'       => '1.0',                                    //版本
            'author'        => 'Runtuer',                                //作者
            ...
            'special'       => array(
                'logo'      => 'alertpay.png',
                'country'   => ['en-us'],   //适用国家
                'appofficial'  => 'https://www.alertpay.com/',         //官方
            ),
        );
    }
