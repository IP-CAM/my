...
// +----------------------------------------------------------------------
// | Worldpay  Version 1.0  2016/3/14
// +----------------------------------------------------------------------
namespace payments;
...
class Worldpay extends Payment
{
    ...
    static public function setup(){
        return array(
            ...
            'code'          => 'Worldpay',     // 扩展器名称名
            'name'          => lang('Worldpay_payment'), // 扩展器名称翻译名
            'description'   => lang('Worldpay_payment_desc'), // 扩展器名称翻译描述
            'version'       => '1.0',                                    //版本
            'author'        => 'Runtuer',                                //作者
            ...
            'special'       => array(
                'logo'      => 'worldpay.png',
                'appofficial'  => 'https://www.payoneer.com',       //官方
                'country'   => ['en-us'],   //适用国家
            ),
        );
    }
