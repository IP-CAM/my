...
// +----------------------------------------------------------------------
// | Chinabank  Version 1.0  2016/3/14
// +----------------------------------------------------------------------
namespace payments;
...
class Chinabank extends Payment
{
    ...
    static public function setup(){
        return array(
            ...
            'code'          => 'Chinabank',     // 扩展器名称名
            'name'          => lang('Chinabank_payment'), // 扩展器名称翻译名
            'description'   => lang('Chinabank_payment_desc'), // 扩展器名称翻译描述
            'version'       => '1.0',                                    //版本
            'author'        => 'Runtuer',                                //作者
