...
// +----------------------------------------------------------------------
// | 分期付款  Version 1.0  2016/3/14
// +----------------------------------------------------------------------
namespace payments;

use app\common\libs\Payment;

class Stages extends Payment
{
    /**
     * @Mark:扩展配置信息
     * @Author: theseaer <theseaer@qq.com>
    ...
    public static function setup(){
        return array(
            ...
            'code'          => 'Stages',      // 扩展器名称名
            'name'          => lang('Stages_payment'), // 扩展器名称翻译名
            'description'   => lang('Stages_payment_desc'), // 扩展器名称翻译描述
            'version'       => '1.0',                                    //版本
            'author'        => 'Runtuer',                                //作者
            ...
            'special'       => array(
                'logo'      => 'stages.png',
                'appofficial'  => 'https://stagescycling.com/',       //官方
                'country'   => ['en-us'],   //适用国家
            ),
        );
    }
