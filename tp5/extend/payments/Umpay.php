...
// +----------------------------------------------------------------------
// | Umpay  Version 1.0  2016/3/14
// +----------------------------------------------------------------------
namespace payments;

use app\common\libs\Payment;

class Umpay extends Payment
{
    /**
     * @Mark:扩展配置信息
     * @Author: theseaer <theseaer@qq.com>
    ...
    static public function setup(){
        return array(
            ...
            'code'          => 'Umpay',     // 扩展器名称名
            'name'          => lang('Umpay_payment'), // 扩展器名称翻译名
            'description'   => lang('Umpay_payment_desc'), // 扩展器名称翻译描述
            'version'       => '1.0',                                    //版本
            'author'        => 'Runtuer',                                //作者
            ...
            'special'       => array(
                'logo'      => 'umpay.png',
                'appofficial'  => 'http://www.umpay.com/',       //官方
                'country'   => ['en-us'],   //适用国家
            ),
        );
    }
