...
// +----------------------------------------------------------------------
// | 红包方式支付  Version 1.0  2016/3/14
// +----------------------------------------------------------------------
namespace payments;

use app\common\libs\Payment;

class Hong extends Payment
{
    ...
    static public function setup(){
        return array(
            ...
            'code'          => 'Hong',     // 扩展器名称名
            'name'          => lang('Hong_payment'), // 扩展器名称翻译名
            'description'   => lang('Hong_payment_desc'), // 扩展器名称翻译描述
            'version'       => '1.0',                                    //版本
            'author'        => 'Runtuer',                                //作者
            ...
            'special'       => array(
                'logo'      => 'hong.png',
                'appofficial'  => 'https://www.hongpay.com.cn',       //官方
                'country'   => ['zh-cn'],   //适用国家
            ),
        );
    }
