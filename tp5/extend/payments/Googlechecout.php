...
// +----------------------------------------------------------------------
// | Googlechecout  Version 1.0  2016/3/14
// +----------------------------------------------------------------------
namespace payments;

use app\common\libs\Payment;

class Googlechecout extends Payment
{
    ...
    public static function setup(){
        return array(
            ...
            'code'          => 'Googlechecout',     // 扩展器名称名
            'name'          => lang('Googlechecout_payment'), // 扩展器名称翻译名
            'description'   => lang('Googlechecout_payment_desc'), // 扩展器名称翻译描述
            'version'       => '1.0',                                    //版本
            'author'        => 'Runtuer',                                //作者
            ...
            //特殊配置项目，可自行定义
            'special'       => array(
                'logo'      => 'googlechecout.png',
                'appofficial'  => 'http://checkout.google.com',       //官方
                //'country'   => [],   //适用国家
            ),
        );
    }
