...
// +----------------------------------------------------------------------
// | Xpay  Version 1.0  2016/3/14
// +----------------------------------------------------------------------
namespace payments;

use app\common\libs\Payment;

class Agentpay extends Payment
{
    /**
     * @Mark:扩展配置信息
     * @Author: theseaer <theseaer@qq.com>
    ...
    static public function setup(){
        return array(
            ...
            'code'          => 'Agentpay',     // 扩展器名称名
            'name'          => lang('Agentpay_payment'), // 扩展器名称翻译名
            'description'   => lang('Agentpay_payment_desc'), // 扩展器名称翻译描述
            'version'       => '1.0',                              //版本
            'author'        => 'Runtuer',                          //作者
