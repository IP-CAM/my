...
// +----------------------------------------------------------------------
// | 分期消费贷款支付（分期支付）  Version 1.0  2016/3/14
// +----------------------------------------------------------------------
namespace payments;

use app\common\libs\Payment;

class Bystages extends Payment
{
    ...
    public static function setup(){
        return array(
            ...
            'code'          => 'Bystages',     // 扩展器名称名
            'name'          => lang('Bystages_payment'), // 扩展器名称翻译名
            'description'   => lang('Bystages_payment_desc'), // 扩展器名称翻译描述
            'version'       => '1.0',                                    //版本
            'author'        => 'Runtuer',                                //作者
