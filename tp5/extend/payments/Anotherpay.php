...
// +----------------------------------------------------------------------
// | 代付  Version 1.0  2016/3/14
// +----------------------------------------------------------------------
namespace payments;

use app\common\libs\Payment;

class Anotherpay extends Payment
{
    /**
     * @Mark:扩展配置信息
     * @Author: theseaer <theseaer@qq.com>
    ...
    static public function setup(){
        return array(
            ...
            'code'          => 'Anotherpay',                    // 扩展器名称名
            'name'          => lang('Anotherpay_payment'),      //翻译名
            'description'   => lang('Anotherpay_payment_desc'), //描述
