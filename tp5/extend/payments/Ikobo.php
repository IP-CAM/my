...
// +----------------------------------------------------------------------
// | Ikobo  Version 1.0  2016/3/14
// +----------------------------------------------------------------------
namespace payments;

use app\common\libs\Payment;

class Ikobo extends Payment
{
    /**
     * @Mark:扩展配置信息
     * @Author: theseaer <theseaer@qq.com>
    ...
    public static function setup(){
        return array(
            ...
            'code'          => 'Ikobo',     // 扩展器名称名
            'name'          => lang('Ikobo_payment'), // 扩展器名称翻译名
            'description'   => lang('Ikobo_payment_desc'), // 扩展器名称翻译描述
            'version'       => '1.0',                                    //版本
            'author'        => 'Runtuer',                                //作者
            ...
            'special'       => array(
                'logo'      => 'ikobo.png',
                'appofficial'  => 'http://www.ikobo.com/',       //官方
                'country'   => ['en-us'],   //适用国家
            ),
        );
    }
