...
// +----------------------------------------------------------------------
// | Moneybookers  Version 1.0  2016/3/14
// +----------------------------------------------------------------------
namespace payments;

use app\common\libs\Payment;

class Moneybookers extends Payment
{
    /**
     * @Mark:扩展配置信息
     * @Author: theseaer <theseaer@qq.com>
    ...
    public static function setup(){
        return array(
            ...
            'code'          => 'Moneybookers',     // 扩展器名称名
            'name'          => lang('Moneybookers_payment'), // 扩展器名称翻译名
            'description'   => lang('Moneybookers_payment_desc'), // 扩展器名称翻译描述
            'version'       => '1.0',                                    //版本
            'author'        => 'Runtuer',                                //作者
            ...
            'special'       => array(
                ...
                'appofficial'  => 'https://www.skrill.com/en/',       //官方
                'country'   => ['en-us'],   //适用国家
            ),
        );
    }
