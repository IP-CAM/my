...
// +----------------------------------------------------------------------
// | Ukash  Version 1.0  2016/3/14
// +----------------------------------------------------------------------
namespace payments;

use app\common\libs\Payment;

class Ukash extends Payment
{
    /**
     * @Mark:扩展配置信息
     * @Author: theseaer <theseaer@qq.com>
    ...
    public static function setup(){
        return array(
            ...
            'code'          => 'Ukash',     // 扩展器名称名
            'name'          => lang('Ukash_payment'), // 扩展器名称翻译名
            'description'   => lang('Ukash_payment_desc'), // 扩展器名称翻译描述
            'version'       => '1.0',                                    //版本
            'author'        => 'Runtuer',                                //作者
            ...
            'special'       => array(
                'logo'      => 'ukash.png',
                'appofficial'  => 'http://www.ukash.com/',       //官方
                'country'   => ['en-us'],   //适用国家
            ),
        );
    }
