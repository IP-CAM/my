<?php
/**
 * 依照Zend Framework框架下的zend_escaper改写的编码器类
 * 其作用：将PHP输出到页面的字符串按不同种类进行编码输出，包括：html编码、html属性编码、JS编码、CSS编码，具有防止一定的XSS攻击作用
 */
    ...
    public function __construct($encoding = null)
    {
        if ($encoding !== null) {
            ...
            if (!in_array($encoding, $this->supportedEncodings)) {
                ...
                throw new Exception('Value of \'' . $encoding . '\' passed to ' . get_class($this)
