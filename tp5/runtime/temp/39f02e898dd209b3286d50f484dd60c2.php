<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:54:"D:\git\my\tp5\public/../site/admin/view/seo\index.html";i:1503361789;s:56:"D:\git\my\tp5\public/../site/admin/view/public\base.html";i:1506158164;s:56:"D:\git\my\tp5\public/../site/admin/view/public\navs.html";i:1503361789;s:56:"D:\git\my\tp5\public/../site/admin/view/public\lang.html";i:1503361789;s:58:"D:\git\my\tp5\public/../site/admin/view/public\button.html";i:1503361789;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8" />
			...
			<div class="content">
                ...
                <dl class="gzzt clearfix mtb10">
                    ...
                    <?php if(!(empty($group) || (($group instanceof \think\Collection || $group instanceof \think\Paginator ) && $group->isEmpty()))): ?>
						<select name="group" id="group" style="height:25px; min-width:60px;">
                           <option value="<?php echo url('index?type=main'); ?>"><?php echo lang('All'); ?></option>
                           ...
                           <option value="<?php echo url('index',array_merge($inputarr,array('gid'=>$key))); ?>" <?php if($gid == $key): ?>selected<?php endif; ?>><?php echo lang($vo); ?></option>
                    ...
                    <form style="margin-top:0;" class="search-form">
                        <dd>
                            <div class="boxr ovh">
                              ...
                              <input type="text" class="searchinput" name="name" value="<?php echo input('name'); ?>" placeholder="<?php echo lang('Search_tip'); ?>" style="width:120px;"/>
                              </label>
                              <input type="button" name="search" id="sch-search" class="button white" value="<?php echo lang('Search'); ?>" url="<?php echo url('', input('name')); ?>"/>
                            </div>
                        <dd>
                    ...
                    <dt><?php echo lang('Config_count'); ?></dt>
                    <dd>
                        <div class="boxl fl">
                            <span><?php echo lang('Count_all'); ?>：<b><?php echo $_total; ?></b></span>
                            <span class="red"><?php echo lang('Disable'); ?>：<b>0</b></span>
                            <span class="green"><?php echo lang('Enable'); ?>：<b>0</b></span>
                        </div>
                    </dd>
                </dl>
                ...
                <table class="table">
                    ...
                    <tr>
                        ...
                        <th class="left"><a href="<?php echo getUrlbyOrder(); ?>"><?php echo lang('Name'); ?></a></th>
                        <th class="left"><a href="<?php echo getUrlbyOrder('title'); ?>"><?php echo lang('Title'); ?></a></th>
                        <th class="center"><a href="<?php echo getUrlbyOrder('group'); ?>"><?php echo lang('Group'); ?></a></th>
                        <th class="center" style="width:60px;"><a href="<?php echo getUrlbyOrder('type'); ?>"><?php echo lang('Type'); ?></a></th>
                        <th class="left"><?php echo lang('Remark'); ?></th>
                        <th class="center" style="width:50px;"><a href="<?php echo getUrlbyOrder('status'); ?>"><?php echo lang('Status'); ?></a></th>
                        <th class="center"><a href="<?php echo getUrlbyOrder('sort'); ?>"><?php echo lang('Sort'); ?></a></th>
                        <th class="actions" style="width:70px;"><?php echo lang('Actions'); ?></th>
                    </tr>
                    </thead>
                    ...
                    <tr>
                        <td class="center"><input class="ids" type="checkbox" value="<?php echo $vo['id']; ?>" name="ids[]"></td>
                        <td class="left"><?php echo $vo['id']; ?></td>
                        <td class="left">
                        <a class="tooltip-link ajax-get edit" title="<?php echo lang('Edit_this_record'); ?>" href="<?php echo url('edit',array('ids'=>$vo['id'])); ?>" data-title="<?php echo lang('Edit'); ?>">
                        <?php echo $vo['name']; ?>
                        </a>
                        </td>
                        <td class="left"><?php echo $vo['title']; ?></td>
                        <td class="center"><a href="<?php echo url('',array('gid'=>$vo['group'],'menuid'=>I('get.menuid'))); ?>"><?php echo $group[$vo['group']]; ?></a></td>
                        <td class="center"><a href="<?php echo url('',array('tid'=>$vo['type'],'menuid'=>I('get.menuid'))); ?>"><?php echo $otype[$vo['type']]; ?></a></td>
                        <td class="left"><?php echo $vo['remark']; ?></td>
                        <td class="center">
                            <?php if($vo['status'] == 1): ?>
                                <a href="<?php echo url('disable',array('ids'=>$vo['id'])); ?>" class="ajax-able tooltip-link" data-doing="<?php echo lang('Disable'); ?>" title="<?php echo lang('Disable'); ?>">
                            ...
                            <?php else: ?>
                                <a href="<?php echo url('enable',array('ids'=>$vo['id'])); ?>" class="ajax-able tooltip-link" data-doing="<?php echo lang('Enable'); ?>" title="<?php echo lang('Enable'); ?>">
                        ...
                        <td class="actions">
                            ...
                            <a class="tooltip-link ajax-get confirm" title="<?php echo lang('Delete_this_record'); ?>" data-layer="<?php echo lang('Want_delete'); ?>" href="<?php echo url('delete',array('ids'=>$vo['id'])); ?>" data-title="<?php echo lang('Delete'); ?>">
