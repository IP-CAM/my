<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:57:"D:\git\my\tp5\public/../site/admin/view/domain\index.html";i:1505820757;s:56:"D:\git\my\tp5\public/../site/admin/view/public\base.html";i:1506158164;s:56:"D:\git\my\tp5\public/../site/admin/view/public\navs.html";i:1503361789;s:58:"D:\git\my\tp5\public/../site/admin/view/public\button.html";i:1503361789;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8" />
                ...
                <dl class="gzzt clearfix mtb10">
                        <dd>
                            <div class="boxr">
                                ...
                                <select id="app" style="height:27px;margin-right:5px; padding-right: 15px;">
                                    ...
                                    <option url="<?php echo url('', ['apps'=>$apps]); ?>" <?php if($apps ==  input('apps')): ?>selected<?php endif; ?>>
                                    <?php echo $apps; ?>
                                    </option>
                            ...
                            <div class="boxr ovh">
                                <label for="name" style="margin:10px 10px 0 0; width:180px;">
                                    <input type="text" class="searchinput" name="name" id="name"
                                           value="<?php echo input('name'); ?>" placeholder="<?php echo lang('Domain search tip'); ?>"
                                           style="width:150px;"/>
                                </label>
                    ...
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <th class="left"><?php echo lang('Domain'); ?></th>
                            <th class="left"><?php echo lang('Apps'); ?></th>
                            <th class="left"><?php echo lang('Controller'); ?></th>
                            <th class="left"><?php echo lang('Method'); ?></th>
                            <th class="left"><?php echo lang('Domain parameter'); ?></th>
                            <th class="left" style="width:50px;"><?php echo lang('Remark'); ?></th>
                        ...
                        <tr>
                            ...
                            <td class="left"><?php echo $vo['model']; ?></td>
                            <td class="left"><?php echo $vo['controller']; ?></td>
                            <td class="left"><?php echo $vo['remark']; ?></td>
                            <td class="left"><?php echo $vo['parameter']; ?></td>
                            <td class="left"><?php echo $vo['remark']; ?></td>
                            <td class="center">
                                <?php if($vo['status'] == 1): ?>
