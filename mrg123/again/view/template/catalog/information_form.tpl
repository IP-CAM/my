        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-information" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-data">
			  ...
			  <!-- add image release -->
			  <div class="form-group">
                <label class="col-sm-2 control-label" for="input-infocategory"><span data-toggle="tooltip" title="<?php echo $help_infocategory; ?>"><?php echo $entry_infocategory; ?></span></label>
                <div class="col-sm-10">
                  <input type="text" name="infocategory" value="" placeholder="<?php echo $entry_infocategory; ?>" id="input-infocategory" class="form-control" />
                  <div id="infocategory" class="well well-sm" style="height: 150px; overflow: auto;">
                    <?php foreach ($infocategories as $infocategory) { ?>
                    <div id="infocategory<?php echo $infocategory['infocategory_id']; ?>"><i class="fa fa-minus-circle"></i> <?php echo $infocategory['name']; ?>
                      <input type="hidden" name="infocategory[]" value="<?php echo $infocategory['infocategory_id']; ?>" />
                    </div>
                    <?php } ?>
                  </div>
                </div>
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-3">
					<div class="input-group date">
						<input type="text" name="date_release" value="<?php echo $date_release; ?>" placeholder="<?php echo $entry_date_release; ?>" data-date-format="YYYY-MM-DD" id="input-date-release" class="form-control" />
...
// Infocategory
$('input[name=\'infocategory\']').autocomplete({
	...
	'select': function(item) {
		$('input[name=\'infocategory\']').val('');

		$('#infocategory' + item['value']).remove();

		$('#infocategory').append('<div id="infocategory' + item['value'] + '"><i class="fa fa-minus-circle"></i> ' + item['label'] + '<input type="hidden" name="infocategory[]" value="' + item['value'] + '" /></div>');
	}
});

$('#infocategory').delegate('.fa-minus-circle', 'click', function() {
	$(this).parent().remove();
});
//--></script>
<!-- end add -->
