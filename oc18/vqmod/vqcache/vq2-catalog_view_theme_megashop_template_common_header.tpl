...
<div  class="row-offcanvas row-offcanvas-left">
	<?php
		if (isset($request->get['route']) && ($request->get['route'] == 'checkout/quick_checkout')) {
			$shows = false;
		} else {
			$shows = true;
		}
	...
	<div class="mobile-cart">
		<div class="fixed_menu">
			<div class="fixed_menu_list">
				<button type="button" data-toggle="offcanvas" class="btn btn-outline"><i class="fa fa-bars"></i> <span><?php echo $text_category; ?></span></button>
			</div>
			<div class="fixed_menu_user">
				<a href="<?php echo $account; ?>" class="btn btn-outline"><i class="fa fa-user"></i> <span><?php echo $text_account; ?></span></a>
			</div>
			<div class="fixed_menu_cart">
				<a href="<?php echo $shopping_cart; ?>" class="btn btn-outline"><i class="fa fa-shopping-cart"></i> <span><?php echo $text_shopping_cart; ?></span></a>
			</div>
			<div class="fixed_menu_checkout">
				<a href="<?php echo $checkout; ?>" class="btn btn-outline"><i class="fa fa-share"></i> <span><?php echo $text_checkout; ?></span></a>
			</div>
		</div>
	</div>
	<?php } ?>
            ...
            <div id="topbar">
                <div class="container">
                    <div class="show-desktop">
						...
						<div class="quick-access pull-left hidden-xs" style="margin-left:30px;"><?php echo $text_line; ?></div>
						<!--<div class="pull-left hidden-sm hidden-xs">
						<?php if (!$logged) { ?>
						<script src="index.php?route=account/oauth/loadcss&file=oauth_login" type="text/javascript"></script>
...
<div class="popup_dark">
	<div class="popup_box">
		<div class="popup_box_close" onClick="cart.close();"></div>
		<div class="popup_box_message"><span><?php echo $text_popup_message; ?></span></div>
		<div class="popup_box_product" id="popup_window_cart"></div>
		<div class="popup_box_buttons">
			<div class="popup_box_buttons_btn" onClick="cart.close();"><?php echo $text_popup_continue; ?></div>
			<div class="popup_box_buttons_btn"><a href="<?php echo $shopping_cart; ?>"><?php echo $text_popup_cart; ?></a></div>
		</div>
	</div>
</div>
