...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$data['text_print_shipping'] = $this->language->get('text_print_shipping');
		...
		if (isset($this->error['turnback_status'])) {
			$data['error_turnback_status'] = $this->error['turnback_status'];
		} else {
			$data['error_turnback_status'] = '';
		}

		if (isset($this->error['totalorder_status'])) {
			$data['error_totalorder_status'] = $this->error['totalorder_status'];
		} else {
			$data['error_totalorder_status'] = '';
		}

		if (isset($this->error['repeat_status'])) {
			$data['error_repeat_status'] = $this->error['repeat_status'];
		} else {
			$data['error_repeat_status'] = '';
		}
...
$data['config_meta_keyword'] =array();
		...
		if (isset($this->request->post['config_turnback_status'])) {
			$data['config_turnback_status'] = $this->request->post['config_turnback_status'];
		} elseif ($this->config->get('config_turnback_status')) {
			$data['config_turnback_status'] = $this->config->get('config_turnback_status');
		} else {
			$data['config_turnback_status'] = array();
		}

		if (isset($this->request->post['config_totalorder_status'])) {
			$data['config_totalorder_status'] = $this->request->post['config_totalorder_status'];
		} elseif ($this->config->get('config_totalorder_status')) {
			$data['config_totalorder_status'] = $this->config->get('config_totalorder_status');
		} else {
			$data['config_totalorder_status'] = array();
		}

		if (isset($this->request->post['config_repeat_status'])) {
			$data['config_repeat_status'] = $this->request->post['config_repeat_status'];
		} elseif ($this->config->get('config_repeat_status')) {
			$data['config_repeat_status'] = $this->config->get('config_repeat_status');
		} else {
			$data['config_repeat_status'] = array();
		}
	...
	protected function validate() {
		...
		if (!isset($this->request->post['config_turnback_status'])) {
			$this->error['turnback_status'] = 'Order turn back status error!';
		}

		if (!isset($this->request->post['config_totalorder_status'])) {
			$this->error['totalorder_status'] = 'Total order status error!';
		}

		if (!isset($this->request->post['config_repeat_status'])) {
			$this->error['repeat_status'] = 'Repeat order status error!';
		}
