...
// Help
$_['help_address_format']     = '姓名 = {firstname}<br /><br />公司 = {company}<br />地址 = {address_1}<br />地址 2 = {address_2}<br />城市 = {city}<br />郵編 = {postcode}<br />國家地區 = {zone}<br />地區編碼 = {zone_code}<br />國家 = {country}';
