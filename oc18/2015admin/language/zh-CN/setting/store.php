...
$_['entry_image_popup']         = '商品图片弹出尺寸';
$_['entry_image_product']       = '商品列表图片大小';
$_['entry_image_additional']    = '附加商品图像尺寸';
$_['entry_image_related']       = '关联商品图像尺寸';
$_['entry_image_compare']       = '对比商品图片大小';
$_['entry_image_wishlist']      = '收藏商品图片大小';
...
// Help
$_['help_url']                         = '请输入你网店的完整网址。 注意在最後加上 \'/\' 。 例 http//www.opencart.cn/app/<br /><br />请用新的域名或二级域名指定到你的主机。';
...
$_['help_product_limit'] 	             = '确定前台项目中每页显示多少（商品，类别等）';
$_['help_product_description_length']  = '确定前台项目中每页显示多少（商品，类别等）';
...
$_['error_owner']               = '商店拥有者必须在 3 至 64 个字符之间！';
