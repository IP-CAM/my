...
class ControllerSaleOrder extends Controller {
	...
	protected function getList() {
		...
		foreach ($results as $result) {
			$actions = $this->model_sale_order->getOrderActions($result['order_id']);
	...
	public function express() {
		...
		if (isset($this->request->get['order_id'])) {
			...
			$this->model_sale_order->updateOrderAction($this->request->get['order_id'], 'express', 1);
		}
		
		if ($orders) {
			$url .= '&orders='.implode(',', $orders);
		} else {
	...
	public function express_print() {
		...
		if ($express_info) {
			$html  = 'width:'.$express_info['width'].'px;';
			$html .= 'height:'.$express_info['height'].'px;';
		...
		if (isset($this->request->get['orders'])) {
			$order_id = $this->request->get['orders'];
		}
