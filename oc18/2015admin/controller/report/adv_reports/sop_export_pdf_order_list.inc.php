...
ini_set("memory_limit","256M");
	...
	isset($_POST['sop20']) ? $export_pdf_order_list .= "<td align='right'>".$this->language->get('column_orders')."</td>" : '';
	isset($_POST['sop21']) ? $export_pdf_order_list .= "<td align='right'>".$this->language->get('column_customers')."</td>" : '';
	isset($_POST['sop22']) ? $export_pdf_order_list .= "<td align='right'>".$this->language->get('column_products')."</td>" : '';
	isset($_POST['sop23']) ? $export_pdf_order_list .= "<td align='right'>".$this->language->get('column_sub_total')."</td>" : '';
	isset($_POST['sop24']) ? $export_pdf_order_list .= "<td align='right'>".$this->language->get('column_handling')."</td>" : '';
	isset($_POST['sop25']) ? $export_pdf_order_list .= "<td align='right'>".$this->language->get('column_loworder')."</td>" : '';
	isset($_POST['sop27']) ? $export_pdf_order_list .= "<td align='right'>".$this->language->get('column_shipping')."</td>" : '';	
	isset($_POST['sop26']) ? $export_pdf_order_list .= "<td align='right'>".$this->language->get('column_reward')."</td>" : '';
	isset($_POST['sop28']) ? $export_pdf_order_list .= "<td align='right'>".$this->language->get('column_coupon')."</td>" : '';
	isset($_POST['sop29']) ? $export_pdf_order_list .= "<td align='right'>".$this->language->get('column_tax')."</td>" : '';
	isset($_POST['sop30']) ? $export_pdf_order_list .= "<td align='right'>".$this->language->get('column_credit')."</td>" : '';
	isset($_POST['sop31']) ? $export_pdf_order_list .= "<td align='right'>".$this->language->get('column_voucher')."</td>" : '';
	isset($_POST['sop33']) ? $export_pdf_order_list .= "<td align='right'>".$this->language->get('column_total')."</td>" : '';
	isset($_POST['sop37']) ? $export_pdf_order_list .= "<td align='right'>".$this->language->get('column_sales')."</td>" : '';	
	isset($_POST['sop34']) ? $export_pdf_order_list .= "<td align='right'>".$this->language->get('column_prod_costs')."</td>" : '';
	isset($_POST['sop32']) ? $export_pdf_order_list .= "<td align='right'>".$this->language->get('column_commission')."</td>" : '';
	isset($_POST['sop391']) ? $export_pdf_order_list .= "<td align='right'>".$this->language->get('column_payment_cost')."</td>" : '';
	isset($_POST['sop392']) ? $export_pdf_order_list .= "<td align='right'>".$this->language->get('column_shipping_cost')."</td>" : '';
	isset($_POST['sop393']) ? $export_pdf_order_list .= "<td align='right'>".$this->language->get('column_shipping_balance')."</td>" : '';
	isset($_POST['sop38']) ? $export_pdf_order_list .= "<td align='right'>".$this->language->get('column_total_costs')."</td>" : '';	
	isset($_POST['sop35']) ? $export_pdf_order_list .= "<td align='right'>".$this->language->get('column_net_profit')."</td>" : '';
	isset($_POST['sop36']) ? $export_pdf_order_list .= "<td align='right'>".$this->language->get('column_profit_margin')."</td>" : '';
	...
	isset($_POST['sop37']) ? $export_pdf_order_list .= "<td align='right' nowrap='nowrap' class='sales'>".$this->currency->format($total_sales, $this->config->get('config_currency'))."</td>" : '';	
	...
	isset($_POST['sop38']) ? $export_pdf_order_list .= "<td align='right' nowrap='nowrap' class='cost'>".$this->currency->format('-' . ($total_costs), $this->config->get('config_currency'))."</td>" : '';	
	if (($total_sales-$total_costs) >= 0) {
	isset($_POST['sop35']) ? $export_pdf_order_list .= "<td align='right' nowrap='nowrap' class='plusprofit'>".$this->currency->format(($total_sales-$total_costs), $this->config->get('config_currency'))."</td>" : '';
	} else {
	isset($_POST['sop35']) ? $export_pdf_order_list .= "<td align='right' nowrap='nowrap' class='minusprofit'>".$this->currency->format(($total_sales-$total_costs), $this->config->get('config_currency'))."</td>" : '';
	}
	if (($total_costs) > 0) {
	if (($total_sales-$total_costs) >= 0) {
	isset($_POST['sop36']) ? $export_pdf_order_list .= "<td align='right' nowrap='nowrap' class='plusprofit'>".round(100 * (($total_sales-$total_costs) / $total_sales), 2) . '%'."</td>" : '';
	} else {
	isset($_POST['sop36']) ? $export_pdf_order_list .= "<td align='right' nowrap='nowrap' class='minusprofit'>".round(100 * (($total_sales-$total_costs) / $total_sales), 2) . '%'."</td>" : '';
	}
	} else {
	isset($_POST['sop36']) ? $export_pdf_order_list .= "<td align='right' nowrap='nowrap' class='plusprofit'>".'100%'."</td>" : '';
	}							
	...
	$export_pdf_order_list .="<thead><tr>";
		isset($_POST['sop40']) ? $export_pdf_order_list .= "<td align='left'>".$this->language->get('column_order_order_id')."</td>" : '';
		isset($_POST['sop41']) ? $export_pdf_order_list .= "<td align='left'>".$this->language->get('column_order_date_added')."</td>" : '';
		isset($_POST['sop42']) ? $export_pdf_order_list .= "<td align='left'>".$this->language->get('column_order_inv_no')."</td>" : '';
		isset($_POST['sop43']) ? $export_pdf_order_list .= "<td align='left'>".$this->language->get('column_order_customer')."</td>" : '';
		isset($_POST['sop44']) ? $export_pdf_order_list .= "<td align='left'>".$this->language->get('column_order_email')."</td>" : '';
		isset($_POST['sop45']) ? $export_pdf_order_list .= "<td align='left'>".$this->language->get('column_order_customer_group')."</td>" : '';
		isset($_POST['sop46']) ? $export_pdf_order_list .= "<td align='left'>".$this->language->get('column_order_shipping_method')."</td>" : '';
		isset($_POST['sop47']) ? $export_pdf_order_list .= "<td align='left'>".$this->language->get('column_order_payment_method')."</td>" : '';
		isset($_POST['sop48']) ? $export_pdf_order_list .= "<td align='left'>".$this->language->get('column_order_status')."</td>" : '';
		isset($_POST['sop49']) ? $export_pdf_order_list .= "<td align='left'>".$this->language->get('column_order_store')."</td>" : '';
		isset($_POST['sop50']) ? $export_pdf_order_list .= "<td align='right'>".$this->language->get('column_order_currency')."</td>" : '';
		isset($_POST['sop51']) ? $export_pdf_order_list .= "<td align='right'>".$this->language->get('column_order_quantity')."</td>" : '';
		isset($_POST['sop52']) ? $export_pdf_order_list .= "<td align='right'>".$this->language->get('column_order_sub_total')."</td>" : '';
		isset($_POST['sop54']) ? $export_pdf_order_list .= "<td align='right'>".$this->language->get('column_order_shipping')."</td>" : '';
		isset($_POST['sop55']) ? $export_pdf_order_list .= "<td align='right'>".$this->language->get('column_order_tax')."</td>" : '';
		isset($_POST['sop56']) ? $export_pdf_order_list .= "<td align='right'>".$this->language->get('column_order_value')."</td>" : '';
		isset($_POST['sop53']) ? $export_pdf_order_list .= "<td align='right'>".$this->language->get('column_order_sales')."</td>" : '';
		isset($_POST['sop57']) ? $export_pdf_order_list .= "<td align='right'>".$this->language->get('column_order_costs')."</td>" : '';
		isset($_POST['sop58']) ? $export_pdf_order_list .= "<td align='right'>".$this->language->get('column_order_profit')."</td>" : '';
		isset($_POST['sop59']) ? $export_pdf_order_list .= "<td align='right'>".$this->language->get('column_profit_margin')."</td>" : '';
		$export_pdf_order_list .="</tr></thead>";
		$export_pdf_order_list .="<tbody><tr>";
		...
		isset($_POST['sop46']) ? $export_pdf_order_list .= "<td align='left' nowrap='nowrap'>".strip_tags($result['order_shipping_method'], '<br>')."</td>" : '';
		...
		isset($_POST['sop53']) ? $export_pdf_order_list .= "<td align='right' nowrap='nowrap' class='sales'>".$result['order_sales']."</td>" : '';		
		isset($_POST['sop57']) ? $export_pdf_order_list .= "<td align='right' nowrap='nowrap' class='cost'>-".$result['order_costs']."</td>" : '';
		isset($_POST['sop58']) ? $export_pdf_order_list .= "<td align='right' nowrap='nowrap' style='background-color:#c4d9ee;'>".$result['order_profit']."</td>" : '';
		isset($_POST['sop59']) ? $export_pdf_order_list .= "<td align='right' nowrap='nowrap' style='background-color:#c4d9ee;'>".$result['order_profit_margin_percent'] . '%'."</td>" : '';
		$export_pdf_order_list .= "</tr></tbody></table>";
	...
	isset($_POST['sop20']) ? $export_pdf_order_list .= "<td align='right' nowrap='nowrap' class='total'>".$result['orders_total']."</td>" : '';
	isset($_POST['sop21']) ? $export_pdf_order_list .= "<td align='right' nowrap='nowrap' class='total'>".$result['customers_total']."</td>" : '';
	isset($_POST['sop22']) ? $export_pdf_order_list .= "<td align='right' nowrap='nowrap' class='total'>".$result['products_total']."</td>" : '';
	isset($_POST['sop23']) ? $export_pdf_order_list .= "<td align='right' nowrap='nowrap' class='total'>".$this->currency->format($result['sub_total_total'], $this->config->get('config_currency'))."</td>" : '';
	isset($_POST['sop24']) ? $export_pdf_order_list .= "<td align='right' nowrap='nowrap' class='total'>".$this->currency->format($result['handling_total'], $this->config->get('config_currency'))."</td>" : '';
	isset($_POST['sop25']) ? $export_pdf_order_list .= "<td align='right' nowrap='nowrap' class='total'>".$this->currency->format($result['low_order_fee_total'], $this->config->get('config_currency'))."</td>" : '';
	isset($_POST['sop27']) ? $export_pdf_order_list .= "<td align='right' nowrap='nowrap' class='total'>".$this->currency->format($result['shipping_total'], $this->config->get('config_currency'))."</td>" : '';
	isset($_POST['sop26']) ? $export_pdf_order_list .= "<td align='right' nowrap='nowrap' class='total'>".$this->currency->format($result['reward_total'], $this->config->get('config_currency'))."</td>" : '';
	isset($_POST['sop28']) ? $export_pdf_order_list .= "<td align='right' nowrap='nowrap' class='total'>".$this->currency->format($result['coupon_total'], $this->config->get('config_currency'))."</td>" : '';
	isset($_POST['sop29']) ? $export_pdf_order_list .= "<td align='right' nowrap='nowrap' class='total'>".$this->currency->format($result['tax_total'], $this->config->get('config_currency'))."</td>" : '';
	isset($_POST['sop30']) ? $export_pdf_order_list .= "<td align='right' nowrap='nowrap' class='total'>".$this->currency->format($result['credit_total'], $this->config->get('config_currency'))."</td>" : '';
	isset($_POST['sop31']) ? $export_pdf_order_list .= "<td align='right' nowrap='nowrap' class='total'>".$this->currency->format($result['voucher_total'], $this->config->get('config_currency'))."</td>" : '';
	isset($_POST['sop33']) ? $export_pdf_order_list .= "<td align='right' nowrap='nowrap' class='total'>".$this->currency->format($result['total_total'], $this->config->get('config_currency'))."</td>" : '';
	isset($_POST['sop37']) ? $export_pdf_order_list .= "<td align='right' nowrap='nowrap' class='total_sales'>".$this->currency->format($total_sales_total, $this->config->get('config_currency'))."</td>" : '';
	isset($_POST['sop34']) ? $export_pdf_order_list .= "<td align='right' nowrap='nowrap' class='total'>".$this->currency->format('-' . ($result['prod_costs_total']), $this->config->get('config_currency'))."</td>" : '';
	isset($_POST['sop32']) ? $export_pdf_order_list .= "<td align='right' nowrap='nowrap' class='total'>".$this->currency->format('-' . ($result['commission_total']), $this->config->get('config_currency'))."</td>" : '';
	isset($_POST['sop391']) ? $export_pdf_order_list .= "<td align='right' nowrap='nowrap' class='total'>".$this->currency->format('-' . ($result['pay_costs_total']), $this->config->get('config_currency'))."</td>" : '';
	isset($_POST['sop392']) ? $export_pdf_order_list .= "<td align='right' nowrap='nowrap' class='total'>".$this->currency->format('-' . ($result['ship_costs_total']), $this->config->get('config_currency'))."</td>" : '';
	isset($_POST['sop393']) ? $export_pdf_order_list .= "<td align='right' nowrap='nowrap' class='total'>".$this->currency->format($result['shipping_total']-$result['ship_costs_total'], $this->config->get('config_currency'))."</td>" : '';
	isset($_POST['sop38']) ? $export_pdf_order_list .= "<td align='right' nowrap='nowrap' class='total_cost'>".$this->currency->format('-' . ($total_costs_total), $this->config->get('config_currency'))."</td>" : '';
	if (($total_sales_total-$total_costs_total) >= 0) {
	isset($_POST['sop35']) ? $export_pdf_order_list .= "<td align='right' nowrap='nowrap' class='total_plusprofit'>".$this->currency->format(($total_sales_total-$total_costs_total), $this->config->get('config_currency'))."</td>" : '';
	} else {
	isset($_POST['sop35']) ? $export_pdf_order_list .= "<td align='right' nowrap='nowrap' class='total_minusprofit'>".$this->currency->format(($total_sales_total-$total_costs_total), $this->config->get('config_currency'))."</td>" : '';
	}
	if (($total_costs_total) > 0) {
	if (($total_sales_total-$total_costs_total) >= 0) {
	isset($_POST['sop36']) ? $export_pdf_order_list .= "<td align='right' nowrap='nowrap' class='total_plusprofit'>".round(100 * (($total_sales_total-$total_costs_total) / $total_sales_total), 2) . '%'."</td>" : '';
	} else {
	isset($_POST['sop36']) ? $export_pdf_order_list .= "<td align='right' nowrap='nowrap' class='total_minusprofit'>".round(100 * (($total_sales_total-$total_costs_total) / $total_sales_total), 2) . '%'."</td>" : '';
	}
	} else {
	isset($_POST['sop36']) ? $export_pdf_order_list .= "<td align='right' nowrap='nowrap' class='total_plusprofit'>".'100%'."</td>" : '';	
	}
	$export_pdf_order_list .="</tr></tbody></table>";
