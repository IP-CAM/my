...
ini_set("memory_limit","256M");
	...
	isset($_POST['sop37']) ? $export_html_order_list .= "<td align='right' nowrap='nowrap' class='sales'>".$this->currency->format($total_sales, $this->config->get('config_currency'))."</td>" : '';	
	...
	isset($_POST['sop38']) ? $export_html_order_list .= "<td align='right' nowrap='nowrap' class='cost'>".$this->currency->format('-' . ($total_costs), $this->config->get('config_currency'))."</td>" : '';	
	if (($total_sales-$total_costs) >= 0) {
	isset($_POST['sop35']) ? $export_html_order_list .= "<td align='right' nowrap='nowrap' class='plusprofit'>".$this->currency->format(($total_sales-$total_costs), $this->config->get('config_currency'))."</td>" : '';
	} else {
	isset($_POST['sop35']) ? $export_html_order_list .= "<td align='right' nowrap='nowrap' class='minusprofit'>".$this->currency->format(($total_sales-$total_costs), $this->config->get('config_currency'))."</td>" : '';
	}
	if (($total_costs) > 0) {
	if (($total_sales-$total_costs) >= 0) {
	isset($_POST['sop36']) ? $export_html_order_list .= "<td align='right' nowrap='nowrap' class='plusprofit'>".round(100 * (($total_sales-$total_costs) / $total_sales), 2) . '%'."</td>" : '';
	} else {
	isset($_POST['sop36']) ? $export_html_order_list .= "<td align='right' nowrap='nowrap' class='minusprofit'>".round(100 * (($total_sales-$total_costs) / $total_sales), 2) . '%'."</td>" : '';
	}
	} else {
	isset($_POST['sop36']) ? $export_html_order_list .= "<td align='right' nowrap='nowrap' class='plusprofit'>".'100%'."</td>" : '';
	}						
	$export_html_order_list .="</tr>";
	$export_html_order_list .="<tr>";
	...
	$export_html_order_list .="' align='center'>";
		...
		isset($_POST['sop46']) ? $export_html_order_list .= "<td align='left' nowrap='nowrap'>".strip_tags($result['order_shipping_method'], '<br>')."</td>" : '';
		...
		isset($_POST['sop53']) ? $export_html_order_list .= "<td align='right' nowrap='nowrap' class='sales'>".$result['order_sales']."</td>" : '';		
		isset($_POST['sop57']) ? $export_html_order_list .= "<td align='right' nowrap='nowrap' class='cost'>-".$result['order_costs']."</td>" : '';
		isset($_POST['sop58']) ? $export_html_order_list .= "<td align='right' nowrap='nowrap' style='background-color:#c4d9ee;'>".$result['order_profit']."</td>" : '';
		isset($_POST['sop59']) ? $export_html_order_list .= "<td align='right' nowrap='nowrap' style='background-color:#c4d9ee;'>".$result['order_profit_margin_percent'] . '%'."</td>" : '';	
		$export_html_order_list .="</tr>";					
	...
	isset($_POST['sop20']) ? $export_html_order_list .= "<td align='right' nowrap='nowrap' class='total'>".$result['orders_total']."</td>" : '';
	isset($_POST['sop21']) ? $export_html_order_list .= "<td align='right' nowrap='nowrap' class='total'>".$result['customers_total']."</td>" : '';
	isset($_POST['sop22']) ? $export_html_order_list .= "<td align='right' nowrap='nowrap' class='total'>".$result['products_total']."</td>" : '';
	isset($_POST['sop23']) ? $export_html_order_list .= "<td align='right' nowrap='nowrap' class='total'>".$this->currency->format($result['sub_total_total'], $this->config->get('config_currency'))."</td>" : '';
	isset($_POST['sop24']) ? $export_html_order_list .= "<td align='right' nowrap='nowrap' class='total'>".$this->currency->format($result['handling_total'], $this->config->get('config_currency'))."</td>" : '';
	isset($_POST['sop25']) ? $export_html_order_list .= "<td align='right' nowrap='nowrap' class='total'>".$this->currency->format($result['low_order_fee_total'], $this->config->get('config_currency'))."</td>" : '';
	isset($_POST['sop27']) ? $export_html_order_list .= "<td align='right' nowrap='nowrap' class='total'>".$this->currency->format($result['shipping_total'], $this->config->get('config_currency'))."</td>" : '';
	isset($_POST['sop26']) ? $export_html_order_list .= "<td align='right' nowrap='nowrap' class='total'>".$this->currency->format($result['reward_total'], $this->config->get('config_currency'))."</td>" : '';
	isset($_POST['sop28']) ? $export_html_order_list .= "<td align='right' nowrap='nowrap' class='total'>".$this->currency->format($result['coupon_total'], $this->config->get('config_currency'))."</td>" : '';
	isset($_POST['sop29']) ? $export_html_order_list .= "<td align='right' nowrap='nowrap' class='total'>".$this->currency->format($result['tax_total'], $this->config->get('config_currency'))."</td>" : '';
	isset($_POST['sop30']) ? $export_html_order_list .= "<td align='right' nowrap='nowrap' class='total'>".$this->currency->format($result['credit_total'], $this->config->get('config_currency'))."</td>" : '';
	isset($_POST['sop31']) ? $export_html_order_list .= "<td align='right' nowrap='nowrap' class='total'>".$this->currency->format($result['voucher_total'], $this->config->get('config_currency'))."</td>" : '';
	isset($_POST['sop33']) ? $export_html_order_list .= "<td align='right' nowrap='nowrap' class='total'>".$this->currency->format($result['total_total'], $this->config->get('config_currency'))."</td>" : '';
	isset($_POST['sop37']) ? $export_html_order_list .= "<td align='right' nowrap='nowrap' class='total_sales'>".$this->currency->format($total_sales_total, $this->config->get('config_currency'))."</td>" : '';
	isset($_POST['sop34']) ? $export_html_order_list .= "<td align='right' nowrap='nowrap' class='total'>".$this->currency->format('-' . ($result['prod_costs_total']), $this->config->get('config_currency'))."</td>" : '';
	isset($_POST['sop32']) ? $export_html_order_list .= "<td align='right' nowrap='nowrap' class='total'>".$this->currency->format('-' . ($result['commission_total']), $this->config->get('config_currency'))."</td>" : '';
	isset($_POST['sop391']) ? $export_html_order_list .= "<td align='right' nowrap='nowrap' class='total'>".$this->currency->format('-' . ($result['pay_costs_total']), $this->config->get('config_currency'))."</td>" : '';
	isset($_POST['sop392']) ? $export_html_order_list .= "<td align='right' nowrap='nowrap' class='total'>".$this->currency->format('-' . ($result['ship_costs_total']), $this->config->get('config_currency'))."</td>" : '';
	isset($_POST['sop393']) ? $export_html_order_list .= "<td align='right' nowrap='nowrap' class='total'>".$this->currency->format($result['shipping_total']-$result['ship_costs_total'], $this->config->get('config_currency'))."</td>" : '';
	isset($_POST['sop38']) ? $export_html_order_list .= "<td align='right' nowrap='nowrap' class='total_cost'>".$this->currency->format('-' . ($total_costs_total), $this->config->get('config_currency'))."</td>" : '';
	if (($total_sales_total-$total_costs_total) >= 0) {
	isset($_POST['sop35']) ? $export_html_order_list .= "<td align='right' nowrap='nowrap' class='total_plusprofit'>".$this->currency->format(($total_sales_total-$total_costs_total), $this->config->get('config_currency'))."</td>" : '';
	} else {
	isset($_POST['sop35']) ? $export_html_order_list .= "<td align='right' nowrap='nowrap' class='total_minusprofit'>".$this->currency->format(($total_sales_total-$total_costs_total), $this->config->get('config_currency'))."</td>" : '';
	}
	if (($total_costs_total) > 0) {
	if (($total_sales_total-$total_costs_total) >= 0) {
	isset($_POST['sop36']) ? $export_html_order_list .= "<td align='right' nowrap='nowrap' class='total_plusprofit'>".round(100 * (($total_sales_total-$total_costs_total) / $total_sales_total), 2) . '%'."</td>" : '';
	} else {
	isset($_POST['sop36']) ? $export_html_order_list .= "<td align='right' nowrap='nowrap' class='total_minusprofit'>".round(100 * (($total_sales_total-$total_costs_total) / $total_sales_total), 2) . '%'."</td>" : '';
	}
	} else {
	isset($_POST['sop36']) ? $export_html_order_list .= "<td align='right' nowrap='nowrap' class='total_plusprofit'>".'100%'."</td>" : '';	
	}
