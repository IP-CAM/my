...
class ControllerPaymentBankTransfer extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['bank_transfer_description'])) {
			$data['bank_transfer_description'] = $this->request->post['bank_transfer_description'];
		} else {
			$data['bank_transfer_description'] = $this->config->get('bank_transfer_description');
		}
