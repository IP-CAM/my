...
class ControllerPaymentPPExpress extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['pp_express_description'])) {
			$data['pp_express_description'] = $this->request->post['pp_express_description'];
		} else {
			$data['pp_express_description'] = $this->config->get('pp_express_description');
		}
