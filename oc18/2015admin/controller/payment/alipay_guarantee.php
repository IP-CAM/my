...
class ControllerPaymentAlipayGuarantee extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['alipay_guarantee_description'])) {
			$data['alipay_guarantee_description'] = $this->request->post['alipay_guarantee_description'];
		} else {
			$data['alipay_guarantee_description'] = $this->config->get('alipay_guarantee_description');
		}
