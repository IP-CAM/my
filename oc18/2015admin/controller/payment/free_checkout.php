...
class ControllerPaymentFreeCheckout extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['free_checkout_description'])) {
			$data['free_checkout_description'] = $this->request->post['free_checkout_description'];
		} else {
			$data['free_checkout_description'] = $this->config->get('free_checkout_description');
		}
