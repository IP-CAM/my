...
class ControllerCommonMenu extends Controller {
	public function index() {
		...
		$data['geo_ad'] = $this->url->link('design/geo_ad', 'token=' . $this->session->data['token'], 'SSL');
		$data['geo_zone'] = $this->url->link('localisation/geo_zone', 'token=' . $this->session->data['token'], 'SSL');
		$data['gift'] = $this->url->link('catalog/gift', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['link'] = $this->url->link('design/link', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['express'] = $this->url->link('localisation/express', 'token=' . $this->session->data['token'], 'SSL');
