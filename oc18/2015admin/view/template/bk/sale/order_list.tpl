            ...
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-left"><?php echo $order['customer']; ?><?php if ($order['customer_group_id']) { ?><font color="#0066FF">[<?php echo $order['group']; ?>]</font><?php } else { ?><font color="#CCC">[<?php echo $order['group']; ?>]</font><?php } ?></td>
                  <td class="text-left"><?php echo $order['status']; ?></td>
                  <td class="text-right"><?php echo $order['total']; ?></td>
                  <td class="text-left"><?php echo $order['date_added']; ?></td>
                  <td class="text-left"><?php echo $order['date_modified']; ?></td>
                  <td class="text-right"><a href="<?php echo $order['shipping']; ?>" target="_blank" data-toggle="tooltip" title="<?php echo $button_shipping_print; ?>" class="btn btn-<?php echo $order['action_shipping']?'default':'primary'; ?>" id="btn-shipping"><i class="fa fa-truck"></i></a><a href="<?php echo $order['invoice']; ?>" target="_blank" data-toggle="tooltip" title="<?php echo $button_invoice_print; ?>" class="btn btn-<?php echo $order['action_invoice']?'default':'primary'; ?>" id="btn-invoice"><i class="fa fa-print"></i></a><a href="<?php echo $order['express']; ?>" target="_blank" data-toggle="tooltip" title="<?php echo $button_express_print; ?>" class="btn btn-<?php echo $order['action_express']?'default':'primary'; ?>" id="btn-express"><i class="fa fa-check-circle-o"></i></a><a href="<?php echo $order['view']; ?>" data-toggle="tooltip" title="<?php echo $button_view; ?>" class="btn btn-<?php echo $order['action_viewed']?'default':'primary'; ?>"><i class="fa fa-eye"></i></a><a href="<?php echo $order['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a><a href="<?php echo $order['delete']; ?>" id="button-delete<?php echo $order['order_id']; ?>" data-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger"><i class="fa fa-trash-o"></i></a></td>
                </tr>
                <?php } ?>
                <?php } else { ?>
                <tr>
