        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-banner" class="form-horizontal">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
			  ...
			  <input type="hidden" name="width" id="image-width" value="<?php echo $width; ?>" />
			  <input type="hidden" name="height" id="image-height" value="<?php echo $height; ?>" />
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <div class="col-sm-12" id="draggable">
			  <?php
			  if ($thumb) {
			      $style = 'style="height:'.$height.'px; background: url('.$thumb.') no-repeat left top;"';
			  } else {
				  $style = '';
			  }
			  ?>
