        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-option">
              <fieldset>
                <legend><?php echo $text_print; ?></legend>
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-process-status"><?php echo $text_print_shipping; ?></label>
                  <div class="col-sm-10">
                    <div class="well well-sm" style="height: 150px; overflow: auto;">
                      <?php foreach ($order_statuses as $order_status) { ?>
                      <div class="checkbox">
                        <label>
                          <?php if (in_array($order_status['order_status_id'], $config_print_shipping)) { ?>
                          <input type="checkbox" name="config_print_shipping[]" value="<?php echo $order_status['order_status_id']; ?>" checked="checked" />
                          <?php echo $order_status['name']; ?>
                          <?php } else { ?>
                          <input type="checkbox" name="config_print_shipping[]" value="<?php echo $order_status['order_status_id']; ?>" />
                          <?php echo $order_status['name']; ?>
                          <?php } ?>
                        </label>
                      </div>
              ...
              <fieldset>
				...
				<!--################################# 3 #######################################-->
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-turnback-status"><span data-toggle="tooltip" title="订单列表中，显示回退费用的订单状态">訂單回退状態：</span></label>
                  <div class="col-sm-10">
                    <div class="well well-sm" style="height: 150px; overflow: auto;">
                      <?php foreach ($order_statuses as $order_status) { ?>
                      <div class="checkbox">
                        <label>
                          <?php if (in_array($order_status['order_status_id'], $config_turnback_status)) { ?>
                          <input type="checkbox" name="config_turnback_status[]" value="<?php echo $order_status['order_status_id']; ?>" checked="checked" />
                          <?php echo $order_status['name']; ?>
                          <?php } else { ?>
                          <input type="checkbox" name="config_turnback_status[]" value="<?php echo $order_status['order_status_id']; ?>" />
                          <?php echo $order_status['name']; ?>
                          <?php } ?>
                        </label>
                      </div>
                    ...
                    <?php if ($error_turnback_status) { ?>
                    <div class="text-danger"><?php echo $error_turnback_status; ?></div>
                    <?php } ?>
                  </div>
                </div>
				
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-turnback-status"><span data-toggle="tooltip" title="訂單列表中，归属统计订单总数的状態">訂單总数状態：</span></label>
                  <div class="col-sm-10">
                    <div class="well well-sm" style="height: 150px; overflow: auto;">
                      <?php foreach ($order_statuses as $order_status) { ?>
                      <div class="checkbox">
                        <label>
                          <?php if (in_array($order_status['order_status_id'], $config_totalorder_status)) { ?>
                          <input type="checkbox" name="config_totalorder_status[]" value="<?php echo $order_status['order_status_id']; ?>" checked="checked" />
                          <?php echo $order_status['name']; ?>
                          <?php } else { ?>
                          <input type="checkbox" name="config_totalorder_status[]" value="<?php echo $order_status['order_status_id']; ?>" />
                          <?php echo $order_status['name']; ?>
                          <?php } ?>
                        </label>
                      </div>
                    ...
                    <?php if ($error_totalorder_status) { ?>
                    <div class="text-danger"><?php echo $error_totalorder_status; ?></div>
                    <?php } ?>
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-turnback-status"><span data-toggle="tooltip" title="訂單列表中，归属重复订单的状態">訂單重复状態：</span></label>
                  <div class="col-sm-10">
                    <div class="well well-sm" style="height: 150px; overflow: auto;">
                      <?php foreach ($order_statuses as $order_status) { ?>
                      <div class="checkbox">
                        <label>
                          <?php if (in_array($order_status['order_status_id'], $config_repeat_status)) { ?>
                          <input type="checkbox" name="config_repeat_status[]" value="<?php echo $order_status['order_status_id']; ?>" checked="checked" />
                          <?php echo $order_status['name']; ?>
                          <?php } else { ?>
                          <input type="checkbox" name="config_repeat_status[]" value="<?php echo $order_status['order_status_id']; ?>" />
                          <?php echo $order_status['name']; ?>
                          <?php } ?>
                        </label>
                      </div>
                    ...
                    <?php if ($error_repeat_status) { ?>
                    <div class="text-danger"><?php echo $error_repeat_status; ?></div>
                    <?php } ?>
                  </div>
                </div>
				<!--################################# 3 end #######################################-->
