    ...
    <div class="modal-body">
      ...
      <div class="row">
        ...
        <div class="col-sm-3 text-center">
          ...
          <a href="<?php echo $image['href']; ?>" class="thumbnail"><img src="<?php echo $image['thumb']; ?>" alt="<?php echo $image['name']; ?>" title="<?php echo $image['name']; ?>" data-width="<?php echo $image['width']; ?>"  data-height="<?php echo $image['height']; ?>" /></a>
          <label>
            <input type="checkbox" name="path[]" value="<?php echo $image['path']; ?>" />
            <?php echo $image['name']; ?></label>
          <?php } ?>
...
$('a.thumbnail').on('click', function(e) {
	...
	<?php if ($source) { ?>
	$('#<?php echo $source; ?>').attr('style', 'height:'+$(this).find('img').attr('data-height')+'px; background: url('+$(this).attr('href')+') no-repeat left top;');
	$('#image-width').attr('value', $(this).find('img').attr('data-width'));
	$('#image-height').attr('value', $(this).find('img').attr('data-height'));
	<?php } ?>
