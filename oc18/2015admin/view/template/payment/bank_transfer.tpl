        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-bank-transfer" class="form-horizontal">
		  <div class="form-group">
			...
			<div class="col-sm-10">
			  ...
			  <div style="margin-bottom:10px;"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /><textarea name="bank_transfer_description[<?php echo $language['language_id']; ?>]" rows="5" class="form-control"><?php echo $bank_transfer_description[$language['language_id']]?$bank_transfer_description[$language['language_id']]:''; ?></textarea></div>
			  <?php } ?>
			</div>
		  </div>
          <?php foreach ($languages as $language) { ?>
