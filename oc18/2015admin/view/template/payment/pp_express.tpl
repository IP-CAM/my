			...
			<div class="tab-pane active" id="tab-api">
			  <div class="form-group">
				...
				<div class="col-sm-10">
				  ...
				  <div style="margin-bottom:10px;"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /><textarea name="pp_express_description[<?php echo $language['language_id']; ?>]" rows="5" class="form-control"><?php echo $pp_express_description[$language['language_id']]?$pp_express_description[$language['language_id']]:''; ?></textarea></div>
				  <?php } ?>
				</div>
			  </div>
