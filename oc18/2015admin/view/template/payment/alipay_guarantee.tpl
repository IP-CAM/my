            ...
            <div class="tab-pane active" id="tab-general">
			  <div class="form-group">
				...
				<div class="col-sm-10">
				  ...
				  <div style="margin-bottom:10px;"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /><textarea name="alipay_guarantee_description[<?php echo $language['language_id']; ?>]" rows="5" class="form-control"><?php echo $alipay_guarantee_description[$language['language_id']]?$alipay_guarantee_description[$language['language_id']]:''; ?></textarea></div>
				  <?php } ?>
				</div>
			  </div>
