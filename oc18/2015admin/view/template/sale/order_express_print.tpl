...
<div class="print-box" style="overflow:hidden;<?php echo $style; ?>">
	<?php
		$x = $printRow>0?($printRow * $top) + 1.8897:$top;
	?>
	<div class="express-wrap" style="<?php echo 'margin-top:'.$x.'px;'; ?>">
		<?php foreach ($express['value'] as $key => $v) { ?>
