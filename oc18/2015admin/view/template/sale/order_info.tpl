  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
	    <a href="<?php echo $express; ?>" target="_blank" data-toggle="tooltip" title="<?php echo $button_express_print; ?>" class="btn btn-<?php echo $action_express?'default':'primary'; ?>" id="action-express"><i class="fa fa-check-circle-o"></i></a>
		<a href="<?php echo $invoice; ?>" target="_blank" data-toggle="tooltip" title="<?php echo $button_invoice_print; ?>" class="btn btn-<?php echo $action_invoice?'default':'primary'; ?>" id="action-invoice"><i class="fa fa-print"></i></a>
		<a href="<?php echo $shipping; ?>" target="_blank" data-toggle="tooltip" title="<?php echo $button_shipping_print; ?>" class="btn btn-<?php echo $action_shipping?'default':'primary'; ?>" id="action-shipping"><i class="fa fa-truck"></i></a>
        ...
        <div class="tab-content">
          <div class="tab-pane active" id="tab-order">
            <table class="table table-bordered">
              <tr>
                <td colspan="2">
					<a class="btn btn-warning" onclick="updateAction('viewed');">取消已看</a>
					<a class="btn btn-warning" onclick="updateAction('express');">取消快递</a>
					<a class="btn btn-warning" onclick="updateAction('invoice');">取消发票</a>
					<a class="btn btn-warning" onclick="updateAction('shipping');">取消配货</a>
          <?php if ($auto_express) { ?>
          <a class="btn btn-warning" onclick="updateAction('autoexpress'); $(this).remove();">重打快递 <i class="fa fa-share"></i></a>
          <?php } ?>
          <?php if ($auto_shipping) { ?>
          <a class="btn btn-warning" onclick="updateAction('autoshipping'); $(this).remove();">重打配送 <i class="fa fa-share"></i></a>
          <?php } ?>
				</td>
              </tr>
              <tr>
              ...
              <?php if ($os) { ?>
              <tr>
                <td><?php echo $text_os; ?></td>
                <td><?php echo $os; ?></td>
              </tr>
              <?php } ?>
              <?php if ($geo_ad) { ?>
              <tr>
                <td><?php echo $text_geo_ad; ?></td>
                <td><?php echo $geo_ad; ?></td>
              </tr>
              <?php } ?>
              <?php if ($link) { ?>
              <tr>
              ...
              <tr>
                <td>内部附言：</td>
                <td><textarea name="comment_hide" id="comment_hide" class="form-control" rows="5"><?php echo $comment_hide; ?></textarea></td>
              </tr>
            </table>
          </div>
...
function savecomment() {
	$.ajax({
		url: 'index.php?route=sale/order/savecomment&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>',
		type: 'post',
		data: $('#comment_hide'),
		dataType: 'json',	
...
function updateAction(type) {
  $.ajax({
    url: 'index.php?route=sale/order/action&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>&type='+type,
	type: 'get',
    dataType: 'json',
    success: function(json) {
      if (json['error']) {
  ...
  $('#action-'+type).removeClass('btn-default').addClass('btn-primary');
}
//--></script></div>
<?php echo $footer; ?> 