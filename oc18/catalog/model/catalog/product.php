...
class ModelCatalogProduct extends Model {
	...
	public function getProductInfo($product_id) {
		...
		if ($query->num_rows) {
			return array(
				...
				'image'            => $query->row['image_http'] ? 'http://'.$query->row['image'] : $query->row['image'],
	...
	public function getProductImages($product_id) {
		$query = $this->db->query("SELECT *, (SELECT image_http FROM `" . DB_PREFIX . "product` WHERE product_id = '" . (int)$product_id . "') AS image_http FROM " . DB_PREFIX . "product_image WHERE product_id = '" . (int)$product_id . "' ORDER BY sort_order ASC");
		...
		if ($images) {
			foreach ($images as $image) {
				$data[] = array(
					...
					'image'            => $image['image_http'] ? 'http://'.$image['image'] : $image['image'],
