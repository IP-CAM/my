...
<div class="product-extra">
    <ul class="list-unstyled description no-padding">
		...
		<?php } ?>
        <?php if ($weight) { ?>
        <li><i class="fa fa-chevron-down"></i><b><?php echo $text_weight; ?></b> <?php echo $weight; ?> <?php echo $weight_unit; ?></li>
        <?php } ?>
    </ul>
</div>
<?php if ($price) { ?>
...
<div id="product">
    <div class="product-extra">
        <div class="quantity-adder pull-left">
            <span class="control-label pull-left text-qty hidden-xs" for="input-quantity"><?php echo $entry_qty; ?></span>
        ...
        <div class="pull-left action">
            ...
            <div class="cart">
				<?php if ($status) { ?>
                <button type="button" id="button-cart" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-inverse btn-variant form-control">
                ...
                <div style="display:inline-block;
                    ...
                    <i class="fa fa-warning"></i> <span><?php echo $text_no_stock; ?></span>
                </button>
				<?php } ?>
            </div>
...
<div class="tabs-group box">
    ...
    <div class="tab-content" style="padding:15px 10px;">
        <div class="tab-pane pro-description active" id="tab-description"><?php echo $description; ?></div>
        <?php if ($attribute_groups) { ?>
        ...
        <div class="tab-pane" id="tab-review">
            ...
            <div class="hide"> <div id="review-form" class="panel"><div class="panel-body">
                        <form class="form-horizontal ">
                            ...
                            <div class="form-group required">
                                <div class="col-sm-12 rating-start">
