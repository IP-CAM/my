...
<?php $olang = $this->registry->get('language');  $ourl = $this->registry->get('url');  $config = $this->registry->get('config');   ?>
        ...
        <div class="product-meta-inner">
            <div class="left">
                <div class="review clearfix">
                    ...
                    <?php if ( isset($product['rating']) && $config->get('config_review_status')) { ?>
                    <div class="rating">
