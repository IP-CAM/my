...
class ControllerOnepagecheckoutLogin extends Controller {
	public function index() {
		...
		$data['entry_password'] = (!empty($onepagecheckout_manage['login']['password']['label'][$this->config->get('config_language_id')])) ? $onepagecheckout_manage['login']['password']['label'][$this->config->get('config_language_id')] : $this->language->get('entry_email');
