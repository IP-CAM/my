...
<div id="content"><div class="container-fluid">
	...
	<?php } ?>
	<div class="set-size" id="tg_superstar_megamenu">
...
$(document).ready(function() {
	...
	function menu_updatesort(jsonstring) {
		...
		if (mittXHRobjekt) {
			...
			ajaxRequest.open("GET", "index.php?route=extension/module/tg_superstar_megamenu&token=<?php echo $_GET['token']; ?>&jsonstring=" + jsonstring, true);
