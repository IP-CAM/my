		...
		foreach ($this->session->data['compare'] as $key => $product_id) {
			...
			if ($product_info) {
				...
				$data['products'][$product_id] = array(
					...
					'thumb'        => $image,
					'price'        => $price,
'starting_from' => ($product_info['starting_from']?$this->language->get('text_starting_from') . ' ' . $this->currency->format($this->tax->calculate($product_info['starting_from'], $product_info['tax_class_id'], $this->config->get('config_tax')), $this->session->data['currency']):''),
					'special'      => $special,
