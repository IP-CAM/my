...
class ControllerExtensionModuleBanner extends Controller {
	...
	public function index() {
		...
		$data['entry_title_href'] = $this->language->get('entry_title_href');
		$data['entry_title2'] = $this->language->get('entry_title2');
		$data['entry_title2_href'] = $this->language->get('entry_title2_href');
		...
		if (isset($this->request->post['title_href'])) {
			$data['title_href'] = $this->request->post['title_href'];
		} elseif (!empty($module_info)) {
			$data['title_href'] = $module_info['title_href'];
		} else {
			$data['title_href'] = '';
		}
		...
		if (isset($this->request->post['title2_href'])) {
			$data['title2_href'] = $this->request->post['title2_href'];
		} elseif (!empty($module_info)) {
			$data['title2_href'] = $module_info['title2_href'];
		} else {
			$data['title2_href'] = '';
		}
