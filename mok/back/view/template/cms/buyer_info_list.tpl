            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php echo $column_intro;?></td>
                  <td class="text-left"><?php echo $column_introduce;?></td>
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($buyer['buyer_info_id'], $selected)) { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $buyer['buyer_info_id']; ?>" checked="checked" />
                    <?php } else { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $buyer['buyer_info_id']; ?>" />
                    <?php } ?></td>
                  <td class="text-left"><?php echo $buyer['nickname']; ?></td>
                  <td class="text-left"><?php echo $buyer['intro']; ?></td>

                  <td class="text-left"><?php echo $buyer['introduce']; ?></td>
                  <td class="text-right"><a href="<?php echo $buyer['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                </tr>
                <?php } ?>
                <?php } else { ?>
                <tr>
...
$('#button-filter').on('click', function() {
	...
	var filter_product = $('select[title=\'filter_product\']').val();
