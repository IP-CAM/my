...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right"><a href="<?php echo $buyer_info; ?>"  class="btn btn-primary"><?php echo $text_buyer;?></a>
          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($blog['buyer_blog_id'], $selected)) { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $blog['buyer_blog_id']; ?>" checked="checked" />
                    <?php } else { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $blog['buyer_blog_id']; ?>" />
                    <?php } ?></td>
                  <td class="text-left"><?php echo $blog['title']; ?></td>
                  
                  <td class="text-left"><?php echo $blog['product']; ?></td>

                  <td class="text-left"><?php echo $blog['buyer_name']; ?></td>
