			  ...
			  <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  <div class="form-group required">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="special_description[<?php echo $language['language_id']; ?>][name]" value="<?php echo isset($special_description[$language['language_id']]) ? $special_description[$language['language_id']]['name'] : ''; ?>" placeholder="<?php echo $entry_name; ?>" id="input-name<?php echo $language['language_id']; ?>" class="form-control" />
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="special_description[<?php echo $language['language_id']; ?>][tag]" value="<?php echo isset($special_description[$language['language_id']]) ? $special_description[$language['language_id']]['tag'] : ''; ?>" placeholder="<?php echo $entry_tag; ?>" id="input-tag<?php echo $language['language_id']; ?>" class="form-control" />
                    </div>
                  </div>
                </div>
                <?php } ?>
            ...
            <div class="tab-pane" id="tab-general">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  <div id="special-product" class="well well-sm" style="height: 150px; overflow: auto;">
                    <?php foreach ($special_product as $special_product) { ?>
                    <div id="special-product<?php echo $special_product['product_id']; ?>"><i class="fa fa-minus-circle"></i> <?php echo $special_product['name']; ?>
                      <input type="hidden" name="special_product[]" value="<?php echo $special_product['product_id']; ?>" />
                    </div>
                    <?php } ?>
                  </div>
                </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  <div id="special-category" class="well well-sm" style="height: 150px; overflow: auto;">
                    <?php foreach ($special_category as $special_category) { ?>
                    <div id="special-category<?php echo $special_category['category_id']; ?>"><i class="fa fa-minus-circle"></i> <?php echo $special_category['name']; ?>
                      <input type="hidden" name="special_category[]" value="<?php echo $special_category['category_id']; ?>" />
                    </div>
                    <?php } ?>
                  </div>
                </div>
...
$('input[name=\'product\']').autocomplete({
	...
	'select': function(item) {
		...
		$('#special-product').append('<div id="special-product' + item['value'] + '"><i class="fa fa-minus-circle"></i> ' + item['label'] + '<input type="hidden" name="special_product[]" value="' + item['value'] + '" /></div>');	
	}
});
...
$('input[name=\'category\']').autocomplete({
	...
	'select': function(item) {
		...
		$('#special-category' + item['value']).remove();
		
		$('#special-category').append('<div id="special-category' + item['value'] + '"><i class="fa fa-minus-circle"></i> ' + item['label'] + '<input type="hidden" name="special_category[]" value="' + item['value'] + '" /></div>');
	}	
});

$('#special-category').delegate('.fa-minus-circle', 'click', function() {
	$(this).parent().remove();
});
//--></script>
  <?php if ($special_id) { ?>
...
$('#history').load('index.php?route=marketing/special/history&token=<?php echo $token; ?>&special_id=<?php echo $special_id; ?>');
//--></script>
  <?php } ?>
  <script type="text/javascript"><!--
$('.date').datetimepicker({
