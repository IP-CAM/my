            ...
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-left"><?php echo $activity['code']; ?></td>
                  <td class="text-right"><?php echo $activity['clicks']; ?></td>
                  <td class="text-right"><?php echo $activity['orders']; ?></td>
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=activity/activity&token=<?php echo $token; ?>';
