          ...
          <div class="row">
            ...
            <div class="col-sm-6">
			  ...
			  <div class="form-group">
                ...
                <!--<input type="text" name="filter_supplier" value="<?php if(isset($supplier)){ print_r($supplier); }?>" placeholder="<?php print_r( $entry_supplier); ?>" id="input-product" class="form-control" />-->
              </div>
