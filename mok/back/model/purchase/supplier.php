...
class ModelPurchaseSupplier extends Model {
	public function insert_supplier($data)
	{
		...
		$query = $this->db->query("INSERT INTO oc_po_supplier (first_name,last_name,email,telephone,fax,supplier_group_id,date_added) VALUES('".$data['first_name']."','".$data['last_name']."','".$data['email']."','".$data['telephone']."','".$data['fax']."',".$data['supplier_group_id'].",'".$date_added."')");
		if($query)
		{
			return true;
		}
