...
class ModelCmsBlog extends Model {
	public function addBlog($data) {
		...
		$this->db->query("INSERT INTO " . DB_PREFIX . "blog SET featured = '" . (int)$data['featured'] . "', hits = '" . (int)$data['hits'] . "', created = '" . $this->db->escape($data['created']) . "', video_code = '" . $this->db->escape($data['video_code']) . "', user_id = '" . (int)$data['user_id'] . "', manufacturer_id = '" . (int)$data['manufacturer_id'] . "', status = '" . (int)$data['status'] . "', sort_order = '" . (int)$data['sort_order'] . "', date_added = NOW()");
	...
	public function editBlog($blog_id, $data) {
		...
		$this->db->query("UPDATE " . DB_PREFIX . "blog SET featured = '" . (int)$data['featured'] . "', hits = '" . (int)$data['hits'] . "', created = '" . $this->db->escape($data['created']) . "', user_id = '" . (int)$data['user_id'] . "', video_code = '" . $this->db->escape($data['video_code']) . "', manufacturer_id = '" . (int)$data['manufacturer_id'] . "', status = '" . (int)$data['status'] . "',  sort_order = '" . (int)$data['sort_order'] . "', date_modified = NOW() WHERE blog_id = '" . (int)$blog_id . "'");
