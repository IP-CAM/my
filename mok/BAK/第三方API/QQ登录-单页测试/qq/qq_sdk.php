...
class Qq_sdk{  
    ...
    //配置APP参数  
    private $appid     = '101251366';  
    private $appkey = '13e0438ed1b7fb61cd536ec89608cfdc';  
    private $return_url   = 'http://mok.localweb.com/catalog/controller/test/qq/callback.php';  
