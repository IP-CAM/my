            ...
            <div class="weui-cell__bd">
                <div class="ok_order_info">
					...
					<?php foreach ($product['option'] as $option) { ?>
						<p class="ok_order_version"><span>- <?php echo $option['name']; ?>: <?php echo $option['value']; ?></span></p>
					<?php } ?>
...
<div class="ok_bottom weui-flex">
	...
	<?php } ?>
    <a href="pay.html" class="ok_bottom_pay weui-flex__item"><?php echo $text_confirm_payment; ?></a>
</div>
