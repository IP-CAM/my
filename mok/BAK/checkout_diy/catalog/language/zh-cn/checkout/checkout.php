...
$_['text_checkout_account']          = '第 2 步： 帐号及帐单地址';
$_['text_checkout_payment_address']  = '第 2 步： 帐单地址';
...
$_['text_guest']                     = '直接结帐';
$_['text_register_account']          = '注册一个帐号以便您能更方便地购物、检视订单状态、检视购买记录、和更多的管理项目。';
...
// Error
$_['error_warning']                  = '在结帐时出现了问题！ 如果此问题继续存在请使用其它支付方式或<a href="%s">连络我们</a>。';
$_['error_login']                    = '警告：Email 或是密码不正确。';
$_['error_attempts']                 = '警告：您登入帐号失败的次数已达到限制次数，请于小时后再尝试登入。';
...
$_['error_address_1']                = '详细地址的长度必须在 3 到 128 个字之间！';
...
$_['error_no_shipping']              = '警告：无可使用的运送方式，请<a href="%s">连络我们</a>！';
$_['error_payment']                  = '警告：请选择一个支付方式！';
$_['error_no_payment']               = '警告：无可使用的支付方式，请<a href="%s">连络我们</a>！';
...
$_['text_default'] = '默认';
$_['text_totals'] = '订单金额';
$_['text_order_details'] = '订单详情';
$_['text_confirm_payment'] = '确认支付';
$_['text_should_payment'] = '应付';