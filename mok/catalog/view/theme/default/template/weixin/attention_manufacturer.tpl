...
<div class="weui-flex ok_collect_head">
    <a href="<?php echo $manufacturer_href;?>" class="weui-flex__item ok_on"><?php echo $text_manufacturer;?></a>
    <a href="<?php echo $buyer_href;?>" class="weui-flex__item"><?php echo $text_buyer;?></a>
</div>
<!--关注列表-->
    ...
    <div class="weui-cell">
        ...
        <div class="weui-cell__bd">
                ...
                <p class="ok_list_name">
                    ...
                    <i class="ok_focus_icon weui-icon-success-no-circle" data-id="1111"></i>
                     </a>
                </p>
