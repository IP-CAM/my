			...
			<div id="payment-new" style="display: <?php echo ($addresses ? 'none' : 'block'); ?>;">
				...
				<div class="form-group <?php echo $class1; ?> <?php echo ($feild['required'] ? 'required' : ''); ?>">
					<label class="control-label" for="input-payment-firstname"><?php echo $feild['label']; ?></label>
						<input type="text" name="payment_details[firstname]" value="" placeholder="<?php echo $feild['placeholder']; ?>" id="input-payment-firstname" class="formcontrol" />
				</div>
				<?php } ?>
				...
				<div class="form-group <?php echo $class1; ?> <?php echo ($feild['required'] ? 'required' : ''); ?>">
					...
					<input type="text" name="payment_details[lastname]" value="" placeholder="<?php echo $feild['placeholder']; ?>" id="input-payment-lastname" class="formcontrol" />
				</div>
				<?php } ?>
...
$('#payment-existing select[name=\'payment_details[address_id]\']').on('change', function(){
	...
	$.ajax({
		...
		dataType: 'html',
		beforeSend: function(){
			$('#onepagecheckout .ext-payment-method').html('<div class="loader payment-method-loader text-center"><i class="fa fa-spinner fa-pulse fa-5x fa-fw"></i><span class="sr-only">Loading...</span></div>');
