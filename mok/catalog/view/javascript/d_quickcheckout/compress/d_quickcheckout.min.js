...
qc.PaymentAddressView = qc.View.extend({
	...
	events: {
		...
		'change select.zone_id': 'changeZone',
		'change select.city_id': 'changeCity',
	},
	template: '',
	fields: '',
	changeAccount: function(account) {
	...
	changeCountry: function(e) {
		this.model.set('payment_address.zone_id', 0);
	...
	changeZone: function(e) {
		this.model.set('payment_address.city_id',0);
		this.setCity(e.currentTarget.value);
		this.setDistrict(0);
		if (parseInt(config.general.analytics_event)) {
			ga('send', 'event', config.name, 'update', 'payment_address.changeZone');
		}
		preloaderStart();
	},
	setCity: function(zone_id) {
		var that = this;
		$.post('index.php?route=d_quickcheckout/field/getCity', {
			zone_id: zone_id
		}, function(data) {
			that.model.set('config.fields.city_id.options', data);
			that.render();
		}, 'json');
	},
	
	changeCity: function(e) {
		this.model.set('payment_address.district_id', 0);
		this.setDistrict(e.currentTarget.value);
		if (parseInt(config.general.analytics_event)) {
			ga('send', 'event', config.name, 'update', 'payment_address.changeCity');
		}
		preloaderStart();
	},
	setDistrict: function(city_id) {
		var that = this;
		$.post('index.php?route=d_quickcheckout/field/getDistrict', {
			city_id: city_id
		}, function(data) {
			that.model.set('config.fields.district_id.options', data);
			that.render();
		}, 'json');
	},
	/* end add city */
