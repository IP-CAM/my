    ...
    public function initialize(){
        ...
        if($this->setting['general']['clear_session']){
            $this->session->data['guest'] = array(
                ...
                'custom_field' => $this->model_d_quickcheckout_custom_field->setCustomFieldsDefaultSessionData('address', $customer_group_id ),
            ...
            $this->session->data['payment_address'] = array(
				...
				/* add */
				'city_id' =>  $this->setSessionValue('city_id','payment_address', $data, $account, false),
				'district_id' => $this->setSessionValue('district_id','payment_address', $data, $account, false),
				/* end add */
                'country' => '',
                'iso_code_2' => '',
                'iso_code_3' => '',
                'address_format' => '',
                'custom_field' =>  $this->setSessionValue('custom_field','payment_address', $data, $account, false),
                'zone' => '',
                'zone_code' => '',
            ...
            $this->session->data['shipping_address'] = array(
				...
				/* add */
				'city_id' => $this->setSessionValue('city_id','shipping_address', $data, $account, false),
				'district_id' =>$this->setSessionValue('district_id','shipping_address', $data, $account, false),
				/* end add */
                'country' => '',
                'iso_code_2' => '',
                'iso_code_3' => '',
                'address_format' => '',
                'custom_field' => $this->setSessionValue('custom_field','shipping_address', $data, $account, false),
                'zone' => '',
                'zone_code' => '',
                //'address_id' => $this->customer->getAddressId(),
            );
            ...
            $this->session->data['guest'] = array(
				...
				'custom_field' => (!empty($this->session->data['payment_address']['custom_field'])) ? $this->session->data['payment_address']['custom_field'] : $this->model_d_quickcheckout_custom_field->setCustomFieldsDefaultSessionData('address', $customer_group_id ),
            ...
            $this->session->data['payment_address'] = array(
				...
				/* add */
				'city_id' => $this->setSessionValue('city_id','payment_address', $data, $account),
				'district_id' => $this->setSessionValue('district_id','payment_address', $data, $account),
				/* end add */
				...
				'custom_field' => ((!empty($this->session->data['payment_address']['custom_field'])) ?  $this->session->data['payment_address']['custom_field'] : $this->model_d_quickcheckout_custom_field->setCustomFieldsDefaultSessionData('address', $customer_group_id)) + ((!empty($this->session->data['payment_address']['custom_field'])) ? $this->session->data['payment_address']['custom_field'] :  $this->model_d_quickcheckout_custom_field->setCustomFieldsDefaultSessionData('address', $customer_group_id)),
            ...
            $this->session->data['shipping_address'] = array(
               ...
               /* 'custom_field' => ((!empty($this->session->data['shipping_address']['custom_field']['address'])) ? array('address' => $this->session->data['shipping_address']['custom_field']['address']) : $this->model_d_quickcheckout_custom_field->setCustomFieldsDefaultSessionData('address', $customer_group_id )),*/
			     'custom_field' => ((!empty($this->session->data['shipping_address']['custom_field'])) ?  $this->session->data['shipping_address']['custom_field'] : $this->model_d_quickcheckout_custom_field->setCustomFieldsDefaultSessionData('address', $customer_group_id )),
        ...
        if($this->customer->isLogged()){
			...
			/* 与上面的custom_field冲突,无限循环添加数组到$this->session->data['payment_address']['custom_field']
