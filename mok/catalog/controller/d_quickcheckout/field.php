...
class ControllerDQuickcheckoutField extends Controller {
	...
	public function getCity(){
        if(isset($this->request->post['zone_id'])){
            $this->load->model('d_quickcheckout/address');
            $json = $this->model_d_quickcheckout_address->getCitysByZoneId($this->request->post['zone_id']);
        }else{
            $json = false;
        }
	...
	public function getDistrict(){
        if(isset($this->request->post['city_id'])){
            $this->load->model('d_quickcheckout/address');
            $json = $this->model_d_quickcheckout_address->getDistrictsByCityId($this->request->post['city_id']);
        }else{
            $json = false;
        }
