    ...
    public function prepare($json){
        ...
        if(isset($this->request->post['payment_address'])){
            ...
            if(isset($this->request->post['payment_address']['customer_group_id'])){
				...
				$this->request->post['payment_address']['custom_field'] = ((!empty($this->request->post['payment_address']['custom_field'])) ? $this->request->post['payment_address']['custom_field'] : $this->model_d_quickcheckout_custom_field->setCustomFieldsDefaultSessionData('address', $this->request->post['payment_address']['customer_group_id']));
