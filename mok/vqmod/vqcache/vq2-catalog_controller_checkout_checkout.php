...
$this->document->addStyle('catalog/view/theme/default/css/order.css');
...
$this->document->addScript('catalog/view/theme/default/script/ok_order.js','footer');
		*/
		// 默认的脚本
		$this->document->addScript('catalog/view/javascript/jquery/jquery-2.1.1.min.js');
		$this->document->addScript('catalog/view/theme/default/script/zepto.min.js','footer');
