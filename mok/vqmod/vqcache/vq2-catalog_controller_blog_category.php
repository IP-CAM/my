...
class ControllerBlogCategory extends Controller {
	public function index() {
		...
		$this->document->addScript('catalog/view/theme/default/script/ok_content.js','footer');
			...
			$filter_data = array(
				...
				'filter_blog_category_id' => $child_id, 
				'start'              => ($page - 1) * $limit,
				'limit'              => $limit
			);
			...
			$categories = $this->model_blog_category->getBlogCategories($parent_id);
			...
			foreach ($categories as $category) {
				...
				$data['categories'][] = array(
					...
					'href'     => $this->url->link('blog/category', 'way=' . $parent_id . '_' . $category['blog_category_id'])
				);
