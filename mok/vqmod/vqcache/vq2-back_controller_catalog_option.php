	...
	public function autocomplete() {
		...
		if (isset($this->request->get['filter_name'])) {
			...
			foreach ($options as $option) {
				...
				if ($option['type'] == 'select' || $option['type'] == 'radio' || $option['type'] == 'list' || $option['type'] == 'checkbox' || $option['type'] == 'image') {
				...
				if ($option['type'] == 'select' || $option['type'] == 'radio' || $option['type'] == 'list' || $option['type'] == 'checkbox') {
					if ($option['type'] == 'list') {
	$type = 'List';
}
else {
